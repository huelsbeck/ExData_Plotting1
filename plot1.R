...
# This program plots a histogram of Global Active Power in kilowatts by frequency
#   of minutes covering the days from 1st February 2007 to 2nd February 2007.
...
hist(xdf$Global_active_power, freq = TRUE, col = "#DC401A", 
